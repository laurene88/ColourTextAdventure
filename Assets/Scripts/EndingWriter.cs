...
{
    /// <summary>
    /// Singleton pattern which holds all the player information for each game.
    /// Player decision booleans reset each game, however the list of colour endings achieved does not.
    /// </summary>
    ...
    if (QSname == "WhichPieces" && color == "Green"){
        ...
        if (QSname == "last"){ // This ends the game, sets final color, hue, and changes to end scene.
    ...
    // Changes appropriate Ending Booleans to true at end of game.
